...
import { validateBloodType, validateDate, validateEmailAddress, validateGender, validateMbtiType, validatePhoneNumber } from "../../../../../utils/common";
...
const registerAccountService = async (
    ...
    await fastify.pg.transact(async client => {
        const query: QueryType = {
            text: `INSERT INTO app_setting (account_id,
                                            visibility_mbti,
